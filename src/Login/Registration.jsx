    ...
    <section>
      <div className="flex min-h-svh flex-col items-center justify-center gap-6 bg-muted p-6 md:p-10">
        <div className="flex w-full max-w-sm flex-col gap-6">
          ...
          <a href="/" className="text-gray-400 flex text-lg">
          ...
          <form>
            <div className="grid gap-6">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    placeholder="Steph"
                    required
                    className="outline-1 outline-amber-900 rounded-2xl p-2 w-full"
                  />
                </div>
                <div className="grid gap-2">
              ...
              <div className="grid gap-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-700 hover:bg-amber-600 text-white text-lg font-semibold p-3 rounded-3xl mt-3"
                >
                  Sign Up
                </button>
              </div>
