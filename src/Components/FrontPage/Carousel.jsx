      ...
      <section>
        <div className="mt-20 p-6">
          <div className="grid grid-cols-1 gap-10 xl:grid-cols-2">
            <div className="bg-dark-blue p-10 rounded-4xl" data-aos="fade-right" data-aos-duration="2000">
              <img src={img001} alt="" className="w-full h-auto" />
            </div>
            <div className="text-center">
              <h3 className="mb-5 text-3xl font-bold" data-aos="fade-up">
                Trade on shares and buy crypto with Tipo&apos;s Brokers
              </h3>
              <p className="mb-5 text-charcoal-gray font-medium" data-aos="fade-up">
                Invest with competitive trading conditions and choose from
                hundred of companies across global markets.
              </p>
              <Link to="/registration" className="">
                <button
                  className="relative bg-teal text-white-rice text-lg cursor-pointer font-bold outline-none p-4 rounded-2xl border-2 border-transparent overflow-hidden group hover:text-black-spider transition-colors duration-300 ease-in-out"
                  data-aos="zoom-in"
