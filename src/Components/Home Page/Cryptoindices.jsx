  ...
  const indexService = [
    {
      ...
      offerings: [
        {
          icon: <SiBitcoinsv className="text-[#F7931A] mt-0.5 mr-3 text-2xl" />,
          description: "Bitcoin",
        },
        {
        ...
        {
          icon: <SiSolana className="text-[#00FFA3] mt-0.5 mr-3 text-2xl" />,
          description: "Solana",
        },
        {
          icon: <RiXrpFill className="mt-0.5 mr-3 text-2xl" />,
          description: "XRP",
        },
      ],
    },
    {
      ...
      offerings: [
        ...
        {
          icon: <SiCardano className="text-[#0033AD] mt-0.5 mr-3 text-2xl" />,
          description: "Cardano",
        },
        {
          icon: <SiChainlink className="text-[#375BD2] mt-0.5 mr-3 text-2xl" />,
          description: "Chainlink",
        },
        {
          icon: <SiStellar className="text-[#08B5E5] mt-0.5 mr-3 text-2xl" />,
          description: "Stellar",
        },
        {
          icon: <SiHedera className="text-[#282828] mt-0.5 mr-3 text-2xl" />,
          description: "Hedera",
        },
      ],
    },
    {
      ...
      offerings: [
        ...
        {
          icon: (
            <SiBitcoincash className="text-[#0AC18E] mt-0.5 mr-3 text-2xl" />
          ),
          description: "Bitcoin Cash",
        },
        {
          icon: <SiLitecoin className="text-[#BEBEBE] mt-0.5 mr-3 text-2xl" />,
          description: "Lite Coin",
        },
        {
          icon: <SiPolkadot className="text-[#E6007A] mt-0.5 mr-3 text-2xl" />,
          description: "Polkadot",
        },
        {
          icon: <SiTesla className="text-[#CC0000]mt-0.5 mr-3 text-2xl" />,
          description: "Tesla",
        },
      ],
    },
    {
      ...
      offerings: [
        ...
        {
          icon: (
            <SiInternetcomputer className="text-gradient-to-r from-[#00FFA3] to-[#DC1FFF] mt-0.5 mr-3 text-2xl " />
          ),
          description: "Internet Computer",
        },
        {
          icon: <SiSui className="text-[#6AC8FE] mt-0.5 mr-3 text-2xl" />,
          description: "Sui",
        },
        {
          icon: <SiAlgorand className="mt-0.5 mr-3 text-2xl" />,
          description: "Algorand",
        },
        {
          icon: <SiNear className="mt-0.5 mr-3 text-2xl" />,
    ...
    },
    {
      ...
      offerings: [
        {
          icon: (
            <TbCurrencyDogecoin className="text-[#C2A633] mt-0.5 mr-3 text-2xl" />
          ),
          description: "Doge Coin",
        },
        {
          icon: <FaDog className="text-yellow-500 mt-0.5 mr-3 text-2xl" />,
          description: "SHIBA INU",
        },
        {
          icon: <FaLaughBeam className="text-green-500 mt-0.5 mr-3 text-2xl" />,
    ...
    },
    {
      ...
      offerings: [
        {
          icon: <GiJupiter className="text-[#F99B20] mt-0.5 mr-3 text-2xl" />,
          description: "Jupiter",
        },
        {
  ...
  return (
    <section className="py-6 mb-6 bg-gray-50">
      ...
      <section className="mb-20">
        <div className="grid gap-8 grid-cols-1 tablet:grid-cols-2">
          <div
            className="flex justify-center order-2 items-center tablet:order-1"
            data-aos="fade-left"
            data-aos-duration="2000"
          >
          ...
          <div
            className="mb-8 order-1 tablet:order-2"
            data-aos="fade-up"
            data-aos-duration="2000"
          >
            <SectionTitle
      ...
      <section className="mb-20">
        <div className="grid gap-2 px-4 grid-cols-1">
          <div className="mb-0" data-aos="fade-up" data-aos-duration="2000">
            <SectionTitle
          ...
          <div>
            <ul className="grid grid-cols-1 tablet:max-xl:grid-cols-2 xl:grid-cols-4">
              <li className="mt-10 px-4">
                <FaCheckCircle
                  className="text-darker-teal text-3xl tablet:text-4xl mb-6"
                  data-aos="fade-up"
                  data-aos-delay="500"
                />
                <h4
          ...
          <div className="px-6 py-6 mt-2">
            ...
            <div>
              ...
              {indexService.map(({ id, offering, offerings }) => (
                <div key={id} data-aos="fade-left" data-aos-duration="">
                  <div
      ...
      <section>
        <p className="text-gray-600 text-md md:text-lg">
          The Tipo&apos;s broker Crypto Index is Tipo&apos;s broker first
          regulated product, designed with full transparency. Its prospectus
          outlines all key details and has been independently reviewed by an
          auditor. For a comprehensive understanding of Tipo&apos;s broker
          Crypto Indices, including the product’s structure, issuer, and
          associated risks, please download and carefully review the prospectus
          and its first supplement, available in Nigeria.
        </p>
      </section>
    </section>
  );
